    ...
    <header id="header" class="clearfix">
      ...
      <div id="logo">
        <?php if ($logo): ?><div id="site-logo"><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>">
          <?php global $theme; ?>
          <ul><li>
          <a href="http://mif.co.uk"><img id="mif_logo" src="/<?php echo drupal_get_path('theme', $theme) ?>/MIF_black_and_white_logo.png" alt="MIF Logo"></a>
          </li>
          <li>
          <a href="http://biosphericfoundation.com"><img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" /></a>
          </li></ul>
        </a></div><?php endif; ?>
        <h1 id="site-name">
